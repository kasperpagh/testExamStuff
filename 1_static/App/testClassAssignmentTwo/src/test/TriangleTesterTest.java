...
import cphbusiness.pagh.IllegalTriangleException;
import cphbusiness.pagh.InputValidator;
import cphbusiness.pagh.Triangle;
...
public class TriangleTesterTest
{
    ...
    public void inequalityValidationTester()
    {
        ...
        assertFalse(InputValidator.inequalityChecker(Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE)); //Fejler pga Integer overflow
        assertTrue(InputValidator.inequalityChecker(Integer.MAX_VALUE + 1, Integer.MAX_VALUE + 1, Integer.MAX_VALUE + 1));
        assertFalse(InputValidator.inequalityChecker(Integer.MAX_VALUE - 1, Integer.MAX_VALUE - 1, Integer.MAX_VALUE - 1));//Fejler pga Integer overflow
