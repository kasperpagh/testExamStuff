...
public class MyArrayListWithBugs
{
    ...
    {
        if (index < 0 || nextFree < index || nextFree == 0) //ERROR plejede at stå index <= nextFree. + har addet nextFree == 0 så man får en fejl når man henter fra et tomt array.
        {
    ...
    public void add(int index, Object o)
    {
        ...
        {
            /*
            Min ændring ellers "taber" den sidste objekt
             */
            if (i == nextFree - 1)
            {
                list[i + 1] = list[i];
...
// Throws IndexOutOfBoundsException
    public Object remove(int index)
    {
        ...
        Object returnObj = list[index]; //FEJL DEN RETURNER IKKE DET RIGTIGE OBJEKT!
