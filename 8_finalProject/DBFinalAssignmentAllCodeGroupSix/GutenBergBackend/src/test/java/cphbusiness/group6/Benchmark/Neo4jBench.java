...
/*
    static Neo4JConnector monCon = null;
    static Neo4JController yatzi = null;
    static WebDriver driver;

    @BeforeClass
    public static void setup() {
        monCon = new Neo4JConnector();
        yatzi = new Neo4JController();
    ...
    @Test
    public void getNeo4jApi1() throws IOException {
        URL url = new URL("http://167.99.237.199:8080/api/neo4j/books/Copenhagen");
        ...
        URL url2 = new URL("http://167.99.237.199:8080/api/neo4j/books/London");
        ...
        URL url3 = new URL("http://167.99.237.199:8080/api/neo4j/books/Oxford");
        ...
        URL url4 = new URL("http://167.99.237.199:8080/api/neo4j/books/Roskilde");
        ...
        URL url5 = new URL("http://167.99.237.199:8080/api/neo4j/books/Ushuaia");
    ...
    @Test
    public void getNeo4jApi2() throws IOException {
        URL url = new URL("http://167.99.237.199:8080/api/neo4j/plot/Byron");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("GET");
        connection.connect();
        int code = connection.getResponseCode();
        ...
        URL url2 = new URL("http://167.99.237.199:8080/api/neo4j/plot/Denmark");
        HttpURLConnection connection2 = (HttpURLConnection) url2.openConnection();
        connection2.setRequestMethod("GET");
        connection2.connect();
        int code2 = connection2.getResponseCode();
        ...
        URL url3 = new URL("http://167.99.237.199:8080/api/neo4j/plot/Yeast:%20a%20Problem");
        HttpURLConnection connection3 = (HttpURLConnection) url3.openConnection();
        connection3.setRequestMethod("GET");
        connection3.connect();
        int code3 = connection3.getResponseCode();
        ...
        URL url4 = new URL("http://167.99.237.199:8080/api/neo4j/plot/Phantom%20Fortune,%20a%20Novel");
        HttpURLConnection connection4 = (HttpURLConnection) url4.openConnection();
        connection4.setRequestMethod("GET");
        connection4.connect();
        int code4 = connection4.getResponseCode();
        ...
        URL url5 = new URL("http://167.99.237.199:8080/api/neo4j/plot/The%20Gold%20Diggings%20of%20Cape%20Horn:%20A%20Study%20of%20Life%20in%20Tierra%20del%20Fuego%20and%20Patagonia");
        HttpURLConnection connection5 = (HttpURLConnection) url5.openConnection();
        connection5.setRequestMethod("GET");
        connection5.connect();
        int code5 = connection5.getResponseCode();
    ...
    @Test
    public void getNeo4jApi3() throws IOException {
        URL url = new URL("http://167.99.237.199:8080/api/neo4j/booksplot/Bourne,%20Edward%20Gaylord");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("GET");
        connection.connect();
        int code = connection.getResponseCode();
        ...
        URL url2 = new URL("http://167.99.237.199:8080/api/neo4j/booksplot/Various");
        HttpURLConnection connection2 = (HttpURLConnection) url2.openConnection();
        connection2.setRequestMethod("GET");
        connection2.connect();
        int code2 = connection2.getResponseCode();
        ...
        URL url3 = new URL("http://167.99.237.199:8080/api/neo4j/booksplot/Hodgson,%20William%20Hope");
        HttpURLConnection connection3 = (HttpURLConnection) url3.openConnection();
        connection3.setRequestMethod("GET");
        connection3.connect();
        int code3 = connection3.getResponseCode();
        ...
        URL url4 = new URL("http://167.99.237.199:8080/api/neo4j/booksplot/Goldsmith,%20Oliver");
        HttpURLConnection connection4 = (HttpURLConnection) url4.openConnection();
        connection4.setRequestMethod("GET");
        connection4.connect();
        int code4 = connection4.getResponseCode();
        ...
        URL url5 = new URL("http://167.99.237.199:8080/api/neo4j/booksplot/Spears,%20John%20Randolph");
        HttpURLConnection connection5 = (HttpURLConnection) url5.openConnection();
        connection5.setRequestMethod("GET");
        connection5.connect();
        int code5 = connection5.getResponseCode();
    ...
    @Test
    public void getNeo4jApi4() throws IOException {
        URL url = new URL("http://167.99.237.199:8080/api/neo4j/vicinity/43.4052/87.1952");
        HttpURLConnection connection = (HttpURLConnection) url.openConnection();
        connection.setRequestMethod("GET");
        connection.connect();
        int code = connection.getResponseCode();
        ...
        URL url2 = new URL("http://167.99.237.199:8080/api/neo4j/vicinity/10/10");
        HttpURLConnection connection2 = (HttpURLConnection) url2.openConnection();
        connection2.setRequestMethod("GET");
        connection2.connect();
        int code2 = connection2.getResponseCode();
        ...
        URL url3 = new URL("http://167.99.237.199:8080/api/neo4j/vicinity/53.3439/23.0622");
        HttpURLConnection connection3 = (HttpURLConnection) url3.openConnection();
        connection3.setRequestMethod("GET");
        connection3.connect();
        int code3 = connection3.getResponseCode();
        ...
        URL url4 = new URL("http://167.99.237.199:8080/api/neo4j/vicinity/55.682319/12.563728");
        HttpURLConnection connection4 = (HttpURLConnection) url4.openConnection();
        connection4.setRequestMethod("GET");
        connection4.connect();
        int code4 = connection4.getResponseCode();
        ...
        URL url5 = new URL("http://167.99.237.199:8080/api/neo4j/vicinity/38.883139/-77.016278");
        HttpURLConnection connection5 = (HttpURLConnection) url5.openConnection();
        connection5.setRequestMethod("GET");
        connection5.connect();
        int code5 = connection5.getResponseCode();
